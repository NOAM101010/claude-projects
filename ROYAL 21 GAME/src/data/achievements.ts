 ...
 */
/* Rebalanced AGAIN (user feedback: still way too much). Cut everything
   ~65% from the last pass. Achievements should feel like a nod, not a
   payday — the shop is the sink, chips come from playing.
     Bronze  : 25-100
     Silver  : 100-400
     Gold    : 500-1500
     Platinum: 2500-8000 */
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'beginners_luck', tier: 'bronze', trophy: '🍀', name: { he: 'מזל של מתחילים', en: "Beginner's luck" }, desc: { he: 'נצח במשחק הראשון שלך', en: 'Win your very first game' }, stat: 'wins', goal: 1, reward: 75 },
  { id: 'first_blackjack', tier: 'bronze', trophy: '🂡', name: { he: 'Blackjack ראשון', en: 'First Blackjack' }, desc: { he: 'קבל Blackjack אחד', en: 'Land a single Blackjack' }, stat: 'blackjacks', goal: 1, reward: 75 },
  { id: 'first_spin', tier: 'bronze', trophy: '🎰', name: { he: 'משיכה ראשונה', en: 'First pull' }, desc: { he: 'סובב את מכונת המזל 10 פעמים', en: 'Spin the slot machine 10 times' }, stat: 'slSpins', goal: 10, reward: 50 },
  { id: 'scratcher', tier: 'bronze', trophy: '🎫', name: { he: 'מגרד', en: 'Scratcher' }, desc: { he: 'גרד 10 כרטיסים', en: 'Scratch 10 cards' }, stat: 'scCards', goal: 10, reward: 50 },
  { id: 'ten_hands', tier: 'bronze', trophy: '🃏', name: { he: 'מתחמם', en: 'Warming up' }, desc: { he: 'שחק 10 ידיים Blackjack', en: 'Play 10 Blackjack hands' }, stat: 'bjHands', goal: 10, reward: 75 },

  /* ------------------------------- silver: a few sessions ---------------- */
  { id: 'dealer_hates_you', tier: 'silver', trophy: '😤', name: { he: 'הדילר שונא אותך', en: 'The dealer hates you' }, desc: { he: 'קבל 3 Blackjacks', en: 'Land 3 Blackjacks' }, stat: 'blackjacks', goal: 3, reward: 300 },
  { id: 'unstoppable', tier: 'silver', trophy: '🔥', name: { he: 'בלתי ניתן לעצירה', en: 'Unstoppable' }, desc: { he: 'נצח 5 ידיים ברצף', en: 'Win 5 hands in a row' }, stat: 'bestStreak', goal: 5, reward: 200 },
  { id: 'no_luck', tier: 'silver', trophy: '💀', name: { he: 'אין לך מזל', en: 'No luck at all' }, desc: { he: 'הפסד 5 הטלות מטבע ברצף', en: 'Lose 5 coin flips in a row' }, stat: 'cfLossStreak', goal: 5, reward: 150 },
  { id: 'double_or_nothing', tier: 'silver', trophy: '⚡', name: { he: 'כפול או כלום', en: 'Double or nothing' }, desc: { he: 'נצח בסיבוב כפול או כלום', en: 'Win a double-or-nothing round' }, stat: 'doubleOrNothing', goal: 1, reward: 250 },
  { id: 'host', tier: 'silver', trophy: '🎩', social: true, name: { he: 'המארח', en: 'The host' }, desc: { he: 'הוסף 5 חברים', en: 'Add 5 friends' }, stat: 'friendCount', goal: 5, reward: 175 },
  { id: 'jackpot', tier: 'silver', trophy: '💰', name: { he: "ג'קפוט", en: 'Jackpot' }, desc: { he: 'זכה 25 פעמים במכונת המזל', en: 'Win 25 times on the slots' }, stat: 'slWins', goal: 25, reward: 275 },
  ...
  { id: 'table_regular', tier: 'gold', trophy: '♠️', name: { he: 'קבוע בשולחן', en: 'Table regular' }, desc: { he: 'שחק 100 ידיים Blackjack', en: 'Play 100 Blackjack hands' }, stat: 'bjHands', goal: 100, reward: 350 },
  { id: 'collector', tier: 'gold', trophy: '🗝️', name: { he: 'אספן', en: 'Collector' }, desc: { he: 'החזק 20 פריטים', en: 'Own 20 items' }, stat: 'itemCount', goal: 20, reward: 900 },
  { id: 'royal', tier: 'gold', trophy: '🏆', name: { he: 'רויאל', en: 'Royal' }, desc: { he: 'הגע לרמה 25', en: 'Reach level 25' }, stat: 'level', goal: 25, reward: 700 },
  { id: 'big_win', tier: 'gold', trophy: '💸', name: { he: 'הזכייה הגדולה', en: 'The big one' }, desc: { he: 'זכה 25,000 צ׳יפים ביד אחת', en: 'Win 25,000 chips in one hand' }, stat: 'biggestWin', goal: 25000, reward: 1200 },

  /* ------------------------------- platinum: rare ------------------------ */
  { id: 'ice_cold', tier: 'platinum', trophy: '❄️', name: { he: 'קרח', en: 'Ice cold' }, desc: { he: 'נצח 12 ידיים ברצף', en: 'Win 12 hands in a row' }, stat: 'bestStreak', goal: 12, reward: 2500 },
  { id: 'blackjack_master', tier: 'platinum', trophy: '🖤', name: { he: 'מאסטר Blackjack', en: 'Blackjack master' }, desc: { he: 'קבל 25 Blackjacks', en: 'Land 25 Blackjacks' }, stat: 'blackjacks', goal: 25, reward: 4000 },
  { id: 'veteran', tier: 'platinum', trophy: '🕰️', name: { he: 'ותיק הבית', en: 'House veteran' }, desc: { he: 'שחק 1,000 ידיים Blackjack', en: 'Play 1,000 Blackjack hands' }, stat: 'bjHands', goal: 1000, reward: 5000 },
  { id: 'the_royal', tier: 'platinum', trophy: '👑', name: { he: 'ROYAL אמיתי', en: 'Truly Royal' }, desc: { he: 'הגע לרמה 50', en: 'Reach level 50' }, stat: 'level', goal: 50, reward: 7000 },

  /* ------------------------------- poker specials ------------------------- */
  { id: 'streak_master', tier: 'silver', trophy: '🔥', name: { he: 'מאסטר הרצף', en: 'Streak Master' }, desc: { he: 'נצח 10 משחקים ברצף', en: 'Win 10 games in a row' }, stat: 'bestStreak', goal: 10, reward: 400 },
  { id: 'allin_legend', tier: 'gold', trophy: '🎲', name: { he: 'אגדת ה-All-In', en: 'All-In Legend' }, desc: { he: 'נצח ביד פוקר all-in כשהיו לך 10% סיכוי או פחות', en: 'Win an all-in poker hand with 10% equity or less' }, stat: 'allInLongshotWins', goal: 1, reward: 1200 },
