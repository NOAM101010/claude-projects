...
--
-- מה זה עושה:
--   0. (שלב K) מוחק את גביע הפודיום ev_weekly_winner.
--   1. (שלב L) מוחק את 5 מטבעות ה-currencySkin שנוספו בסבב G — כולל ניקוי
--      בעלות/ציוד של שחקנים.
--   2. seed לקלפים ההולוגרפיים (cf_holo) + ידית החבילה + 5 ז׳יטונים חדשים.
--   3. seed/עדכון לחבילה pack_royal_suite ("ערכת שולחן מלכותית").
-- =============================================================================

-- --- 0. (שלב K) הסרת גביע הפודיום -------------------------------------------
