...
insert into public.items (id, category, name, rarity, price, icon, payload) values
  ...
  ('nc_cream', 'nameColor', '{"he":"שם שמנת","en":"Cream Name"}'::jsonb, 'rare', 2000, '🤍', '{"nameColor":"#e8dcc0"}'::jsonb),
  ('nc_neon', 'nameColor', '{"he":"שם ניאון","en":"Neon Name"}'::jsonb, 'epic', 8000, '💚', '{"nameColor":"#39ff8f"}'::jsonb),
